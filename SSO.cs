...
namespace userScript
{
    ...
    public class SSO
    {
        ...
        ///     SSO: Cannot get repsponse from request
        ///     or
        ///     SSO: Failed to get opaque or sid value
        /// </exception>
        private void GetOpaqueAndSID(string hostname, ref string sid, ref string fsid, ref string opaque, ref string protocol)
        {
            ...
            ServicePointManager.ServerCertificateValidationCallback += (sender, cert, chain, sslPolicyErrors) => true; //certificate error
        ...
        /// </returns>
        /// <exception cref="System.Exception">
        ///     SSO: response doesn't contain 'RequestSecurityTokenResponse'.\nResponse:  + responseArr
        ///     or
        ...
        private string GetSSO(string hostname, string ssoHostname, string ssoPort, string loginId, string password, bool isBase64, bool useHttps)
        {
            ...
            var url = string.Format("{8}://{5}:{4}/idp/login?{7}={1}{6}&continue=http%3A%2F%2F{0}{2}{3}%2Ftmtrack%2Ftmtrack.dll%3F", host, sid, doubleDot, port,
                ssoPort, ssoHostname, fsid, sidType, protocol);
            ...
            if (tokenLine == null)
                throw new Exception("SSO: response doesn't contain 'RequestSecurityTokenResponse'.\nPossible reasons:\n" +
                                    ...
                                    "2) SBM is dead.\n" +
                                    "3) SSOToken doesn't support your SBM version.\n");
